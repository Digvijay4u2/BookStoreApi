...
namespace BookStoreApi.Models
{
    public class BookSqlImpl : IBookRepository
    {
        ...
        public Book GetBookById(int id)
        {
          //  List<Book> list = new List<Book>();
            ...
            while (reader.Read())
            {
                ...
                string Img = reader["Image"].ToString();
                book = new Book(Bid, Cid, Title, isbn, year, price, des, pos, status, Img);
            }
            conn.Close();
            return book;
        }
        ...
        {
            comm.CommandText = "update Books set CategoryId = '" + book.CategoryId + "', Title = '" + book.Title + "',  ISBN = '" + book.ISBN + "',  Year = '" + book.Year + "',  Price = '" + book.Price + "',  Description = '" + book.Description + "', Position = '" + book.Position + "' ,Status = '" + book.Status + "', Image = '" + book.Image + "' where BookId = " + id;
            comm.Connection = conn;
            conn.Open();
